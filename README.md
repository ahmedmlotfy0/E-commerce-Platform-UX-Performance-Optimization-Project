E-commerce Platform UX & Performance Optimization Project

Project created for the Sprints & Microsoft Project Management Certificate | August - October 2025

This repository contains the complete project management documentation for the strategic overhaul of the "DemoBlaze" e-commerce website. The goal was to conduct a data-driven analysis of the user experience, identify critical performance bottlenecks, and develop a comprehensive, actionable plan for improvement.

The individual project deliverables can be found in the /Project-Documents folder.

1. Project Objective

To diagnose and resolve key usability and performance issues on the DemoBlaze platform. The primary success metrics were to enhance user satisfaction, increase trust, and improve the conversion rate by creating a faster, more intuitive shopping experience.

2. The Problem: A Data-Driven Diagnosis

A mixed-methods approach combining heuristic analysis and user testing with 15 participants revealed several high-priority issues:

Category Issue Description Supporting Data Impact
Performance Slow page load times create a poor user experience. 5.8-second average page load time due to unoptimized images. High
Checkout Flow The checkout process is unnecessarily long and complex. 5 steps required to complete a purchase, leading to high cart abandonment. High
Usability Cart management is unintuitive. 10 out of 15 users found removing items from the cart difficult. High
Trust Signals The site lacks clear indicators of security and trust. 10 of 15 users did not notice payment logos; policies were hard to find. High
UI/UX Product presentation is weak. 12 of 15 users felt image quality was too low and lacked a zoom feature. High

Key User Feedback:

· "Checkout should be faster, maybe in fewer steps."
· "Images need to be bigger and clearer."
· "I’d like to see the return policy before buying."

3. The Solution: A Three-Sprint Release Plan (v2.0)

I developed a prioritized, agile-based project plan to address these findings over three distinct sprints for Release v2.0.
...
· Implement visible "Remove" buttons in the cart with an "Undo" option.
· Redesign price display to show the original price, discounted price, and percentage saved.
· Add highly visible links to return and shipping policies on product and checkout pages.
...
· Upgrade all product images to high-resolution and implement a zoom feature.
· Add a prominent section for trusted payment logos (Visa, MasterCard, PayPal) at checkout.
...
· Redesign the checkout flow from 5 steps to a streamlined 3-4 step process with a progress bar.
· Optimize all images, enable lazy loading, and minify CSS/JS to achieve a page load time of ≤ 3 seconds.
· Conduct final performance testing to validate speed improvements.
...
· Project Planning & Scoping: Defined project goals, deliverables, and the scope for the v2.0 release.
· User Research & Analysis: Conducted heuristic evaluation, user testing, and feedback synthesis to identify core problems.
· Agile Project Management: Translated user feedback into actionable user stories and organized them into a prioritized three-sprint plan.
· Risk & Release Management: Developed a comprehensive release plan, including pre- and post-release activities, testing protocols (UAT, QA), and a communication strategy.
...
· Data Analysis
· Heuristic EvaluationUsability Cart management is unintuitive. 10 out of 15 users found removing items from the cart difficult. High
Trust Signals The site lacks clear indicators of security and trust. 10 of 15 users did not notice payment logos; policies were hard to find. High
UI/UX Product presentation is weak. 12 of 15 users felt image quality was too low and lacked a zoom feature. High
...
· Stakeholder Communication
· Data Analysis
· Heuristic Evaluation| Category          | Issue Description                                       | Supporting Data                                                              | Impact |
| ----------------- | ------------------------------------------------------- | ---------------------------------------------------------------------------- | ------ |
